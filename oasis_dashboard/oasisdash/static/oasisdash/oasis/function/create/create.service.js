(function () {
    ...
    angular
        ...
        .factory('horizon.dashboard.oasisdash.function.create.service', createService);
    ...
    createService.$inject = [
        ...
        'horizon.dashboard.oasisdash.function.workflow',
    ...
    function createService(model, wizardModalService, toast, createWorkflow, gettext, $qExtensions) {
        ...
        function submit() {
            ...
            return model.createFunction().then(success);
        }
