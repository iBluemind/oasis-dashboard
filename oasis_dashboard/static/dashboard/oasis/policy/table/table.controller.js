...
(function() {
   ...
   */
  angular
    .module('horizon.dashboard.oasis.policy')
    .controller('PolicyTableController', PolicyTableController);

  PolicyTableController.$inject = [
    '$scope',
    '$location',
    'horizon.app.core.openstack-service-api.oasis',
    'horizon.dashboard.oasis.policy.events',
    'horizon.framework.conf.resource-type-registry.service',
    'horizon.dashboard.container-infra.bays.resourceType'
  ];

  function PolicyTableController($scope, $location, magnum, events, registry, bayResourceType) {
    var ctrl = this;
    ctrl.bays = [];
    ctrl.baysSrc = [];
